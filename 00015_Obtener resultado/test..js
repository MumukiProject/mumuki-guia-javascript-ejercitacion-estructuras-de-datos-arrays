...
assert.equal(resultado, 'Ada',`obtenerResultado('Ada', 'Grace', [4, 4, 4], [1, 2, 3]) debería retornar 'Ada' pero fue ${resultado}`);
})
...
assert.equal(resultado, 'Empate',`obtenerResultado('Ada', 'Grace', [3, 5, 5, 7], [4, 1, 2, 9]) debería retornar 'Empate' pero fue ${resultado}`);
})
